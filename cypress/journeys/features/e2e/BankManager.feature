Feature: Frontend Bank Manager Login
    ...
    Scenario: Opciones de Add Customer
    ...
    Scenario: Opciones de Open Account
        Given El usuario ingresa a la seccion de Bank Manager Login
        When El usuario hace click en el boton "Bank Manager Login"
        Then El usuario deberia ver el boton2 "Open Account"
    ...
    Scenario: Opciones de Customers
        Given El usuario ingresa a la seccion de Bank Manager Login
        When El usuario hace click en el boton "Bank Manager Login"
        Then El usuario deberia ver el boton3 "Customers"
